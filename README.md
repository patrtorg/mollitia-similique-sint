...
This repo contains the source code for [Framer Motion](https://github.com/patrtorg/mollitia-similique-sint/tree/main/packages/@patrtorg/mollitia-similique-sint) and [Framer Motion 3D](https://github.com/patrtorg/mollitia-similique-sint/tree/main/packages/@patrtorg/mollitia-similique-sint-3d).
...
-   Want to contribute to Framer Motion? Our [contributing guide](https://github.com/patrtorg/mollitia-similique-sint/blob/master/CONTRIBUTING.md) has you covered.
